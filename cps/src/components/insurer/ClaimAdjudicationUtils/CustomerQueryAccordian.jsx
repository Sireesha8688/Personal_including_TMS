...
const CustomerQueryAccordian = ({ claim }) => {
    ...
    const getQueryData = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `${API_ENDPOINT}/customerclaimsqueries?customerClaimid=${claim.id}`
        );
    ...
    try {
      if (queryRecord) {
        ...
        const response = await axios.put(
          `${API_ENDPOINT}/customerclaimsqueries/${queryRecord.id}`,
    ...
    try {
      ...
      if (queryRecord) {
        ...
        const response = await axios.post(
          `${API_ENDPOINT}/customerclaimsqueries`,
      ...
      await axios.patch(`${API_ENDPOINT}/customerclaims/${claim.id}`, {
...
export default CustomerQueryAccordian;

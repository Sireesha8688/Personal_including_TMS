...
const Login = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      let role = "";
      let userId = null;
      let hospitalId = null; // New: To store hospital ID
      ...
      if (foundUser) {
        userId = foundUser.id;
        if (role === "Hospital") {
          hospitalId = foundUser.id; // Capture hospital ID here
        }
        loginSuccess = true;
      } else {
      ...
      if (loginSuccess) {
        if (role === "Hospital") {
          // Pass hospitalId to the dashboard route
          navigate("/dashboard", { state: { hospitalId: hospitalId } });
        } else {
          navigate("/app", {
            state: {
              role: role,

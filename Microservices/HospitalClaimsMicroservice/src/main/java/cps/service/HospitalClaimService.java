...
public interface HospitalClaimService {
    ...
    Optional<HospitalClaim> partialUpdateClaim(String id, Map<String, Object> updates);
    List<HospitalClaim> findClaimsByFilters(String hospitalId, String hospitalStatus, String insurerStatus);
}

package cps.hospitalclaimqueries.serviceImpl;
...
import cps.hospitalclaimqueries.repository.HospitalClaimsQueryRepository;
...
public class HospitalClaimsQueryServiceImpl implements HospitalClaimsQueryService {
    ...
    public Optional<HospitalClaimsQuery> updateQuery(String id, HospitalClaimsQuery hospitalClaimsQuery) {
        ...
        if (existing.isPresent()) {
            ...
            // Update fields - example updating all fields, adjust as needed
//            existingQuery.setId(hospitalClaimsQuery.getId());

package cps.hospitalclaims.serviceImpl;
...
import cps.hospitalclaims.repository.HospitalClaimRepository;
...
public class HospitalClaimServiceImpl implements HospitalClaimService {
    ...
    public HospitalClaim createClaim(HospitalClaim claim) {
        claim.set_id(null); // Let Mongo generate new ObjectId
    ...
    public Optional<HospitalClaim> updateClaim(String id, HospitalClaim claimDetails) {
        ...
        if (optionalClaim.isPresent()) {
            ...
            // Update the fields - choose which fields you want to update
